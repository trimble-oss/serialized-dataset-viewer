<#
  ...
  Usage:
    .\SignRelease.ps1 -Folder "C:\temp" -Repo "trimble-oss/serialized-dataset-viewer" -SignTool "C:\Sign\SignFiles.exe" -SignPattern "SerializedDataSetViewer.exe" -RemoveUnsigned $true
#>
param (
    ...
    [string]$Repo="trimble-oss/serialized-dataset-viewer",
    # Path of the Trimble Sign Tool to use for signing the executables.
    [string]$SignTool = "C:\Sign\SignFiles.exe",
    # Pattern to match the executables to sign.  Defaults to "SerializedDataSetViewer.exe".
    [string]$SignPattern = "SerializedDataSetViewer.exe",
